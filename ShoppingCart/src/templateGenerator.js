      ...
      <div class="col-12">
          <div class="col-6 text-center">
              <ul>
                  ...
                  <li  class="modal__price" id ="modelqty${
                    details.id
                  }"><strong>$${parseFloat(details.price) *
      parseInt(details.qty)}</strong></li>
                  <li>
                      Color <br>
                      <span name="color-swatch" data-color-value="black" class="color__square square__black ${
                        details.color === "black" ? "color__selected" : ""
                      }"></span>
                      <span name="color-swatch" data-color-value="blue" class="color__square square__blue ${
                        details.color === "blue" ? "color__selected" : ""
                      }"></span>
                      <span name="color-swatch" data-color-value="pink" class="color__square square__pink ${
                        details.color === "pink" ? "color__selected" : ""
                      }"></span>
                      <span name="color-swatch" data-color-value="green" class="color__square square__green ${
                        details.color === "green" ? "color__selected" : ""
                      }"></span>
                  </li>
                  <li>
                      <select id ="sizeSelect">
                          ...
                          <option value="S" ${
                            details.size === "S" ? "selected" : ""
                          }>S</option>
                          <option value="M" ${
                            details.size === "M" ? "selected" : ""
                          }>M</option>
                          <option value="L" ${
                            details.size === "L" ? "selected" : ""
                          }>L</option>
                      </select>
                      <select id ="qtySelect">
                          <option value="1" ${
                            +details.qty === 1 ? "selected" : ""
                          }>QTY:1</option>
                          <option value="2" ${
                            +details.qty === 2 ? "selected" : ""
                          }>QTY:2</option>
                          <option value="3" ${
                            +details.qty === 3 ? "selected" : ""
                          }>QTY:3</option>
                          <option value="4" ${
                            +details.qty === 4 ? "selected" : ""
                          }>QTY:4</option>
                      </select>
                  </li>
                  <li>
  ...
  <div class="desktop-view">
      ...
      <div class="col-1">
          <input type="text" data-Id="${
            result.id
          }" name="qty" readonly value="${result.qty}">
      </div>
      <div class="col-1">
          <p id="price${result.id}" data-price="${
      result.price
    }"><strong>$${parseFloat(result.price) *
      parseFloat(result.qty)}</strong></p>
      </div>
  </div>
